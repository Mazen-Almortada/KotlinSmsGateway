...
class GetFilteredMessagesUseCase @Inject constructor(
    ...
    private val contactsRepository: ContactsRepository // Context is needed for resolving contact names
) {
    operator fun invoke(
        ...
        val allMessagesWithDetails = combine(
            ...
            messages.map { message ->
                val contactName = contactsRepository.findContactName(message.recipient)
